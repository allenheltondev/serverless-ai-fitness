    ...
    <Card variation="elevated" width="fit-content" height="auto" transition="'0.5s" paddingRight={isOpen ? "2em" : "1em"}>
      <Flex direction="column" justifyContent="space-between" height="100%">
        <Flex direction="column" gap="1em" alignItems="flex-start" >
          ...
          <Flex direction="row" gap=".5em" alignItems="center" style={{ cursor: "pointer" }} onClick={() => router.push('/workouts')}>
            <RiArchiveDrawerLine color="black" size="1.5em" />
            {isOpen && <Text marginLeft=".6em">Browse</Text>}
          </Flex>
